...
if sys.platform == "win32":
    # Matched hit snippets can contain arbitrary source-file Unicode (math
    # symbols, accented Portuguese text, …); a non-UTF-8 Windows console
    # codepage otherwise crashes this gate mid-scan instead of reporting
    # its findings.
