...
| D-AI-05 | P3 | NEAT / HyperNEAT productization | **Closed 2026-08-17** (NEAT/HyperNEAT); **ES-HyperNEAT closed 2026-08-23** — ADR 0048 Gauci loop on `es_quadtree` (per-source quadtree, extraction, band pruning, iteration). |
...
| D-AI-05 (HyperNEAT) | 2026-08-17 | Governed HyperNEAT: ADR 0045, `evolutionary.hyperneat`, `run_hyperneat()`, `build_hyperneat_experiment`, fixed `layered_1d` substrate, CPPN + substrate IR. |
| D-AI-05 (ES-HyperNEAT) | 2026-08-23 | ADR 0048 Gauci & Stanley: per-source 4D quadtree, extraction, band pruning, hidden-as-source iteration. `algorithm=es_hyperneat` only on this path. |
