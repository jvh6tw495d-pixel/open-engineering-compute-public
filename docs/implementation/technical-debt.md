...
| D-AI-05 | P3 | NEAT / HyperNEAT productization | **Excluded from 3.6 DoD** — ADR 0042 (re-open only with new ADR). S4 ships catalog hardening for existing evo/hybrid builders only; NEAT is not residual “TODO soon”. |
