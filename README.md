...
> **Status:** **v2.1.0 Quantities alpha** (private; V3 roadmap).
...
**v2.1.0** delivers JSON-safe Quantity dimensional contracts, fail-closed physical
I/O enforcement, and migration of the energy/battery skills to `QuantityValue`-only
contracts — see [CHANGELOG.md](CHANGELOG.md) and
[v2.1 delivery status](docs/implementation/v2.1-delivery-status-and-v2.5-next-steps.md).
Math IR, the Backend Capability Registry, and formal Verification are **v2.2+**.
